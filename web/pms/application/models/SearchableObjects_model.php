...
class SearchableObjects_model extends Application_model {
	...
	private $timePeriods = [
		"today" => "DATE(`created_at`) = NOW()",
		"yesterday" => "(DATE(`created_at`) BETWEEN DATE_SUB(NOW(), INTERVAL 1 DAY) AND NOW())",
		"pastweek" => "(DATE(`created_at`) BETWEEN DATE_SUB(NOW(), INTERVAL 7 DAY) AND NOW())",
		"pastmonth" => "(DATE(`created_at`) BETWEEN DATE_SUB(NOW(), INTERVAL 1 MONTH) AND NOW())",
		"past3months" => "(DATE(`created_at`) BETWEEN DATE_SUB(NOW(), INTERVAL 3 MONTH) AND NOW())",
		"past6months" => "(DATE(`created_at`) BETWEEN DATE_SUB(NOW(), INTERVAL 6 MONTH) AND NOW())",
		"pastyear" => "(DATE(`created_at`) BETWEEN DATE_SUB(NOW(), INTERVAL 1 YEAR) AND NOW())"
	];
