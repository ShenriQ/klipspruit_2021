...
tpl_assign("title_for_layout", ($transaction_log->isNew() ? lang('c_372') : lang('c_373').' # '.$transaction_log->getId())); ?>

<form method="post" action="<?php echo get_page_base_url($transaction_log->isNew() ? 'transactions/create/expense/0' : $transaction_log->getEditURL("expense")); ?>" id="i_expense_form" class="form-horizontal">
