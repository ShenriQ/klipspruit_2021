...
tpl_assign("title_for_layout", 'Add Widget'); ?>

<form method="post" action="<?php echo get_page_base_url('admin/widgets/add'); ?>" id="i_widget_form"
